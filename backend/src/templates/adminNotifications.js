 ...
 * Alert the Climb Crux team ONLY when a customer uploads & submits their
 * payment screenshot: booking payment proof, equipment-order payment proof,
 * and new membership applications (which include the screenshot). These act
 * as a reminder to review the payment in the admin dashboard. Built on the
 * same shared layout as the customer emails.
 */
...
/** New membership application (with payment screenshot) → admin alert. */
