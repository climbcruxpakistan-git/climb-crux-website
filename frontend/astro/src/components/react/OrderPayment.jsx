...
import { getOrderByNumber, submitOrderPaymentProof } from '../../lib/api'

/**
 * Equipment-order payment component (manual verification workflow). The
 * customer arrives right after placing an order (Order ID: CCE-XXXXXX). They
 * see the total, both payment methods' details, and upload their payment
