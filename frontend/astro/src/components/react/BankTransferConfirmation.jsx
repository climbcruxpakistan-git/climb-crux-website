...
export default function BankTransferConfirmation({ bookingNumber }) {
        ...
        <div className="bank-whatsapp-section" style={{ width: '100%', marginBottom: 8, textAlign: 'left' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14, marginBottom: 24 }}>
            <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
              ...
              <div><strong style={{ display: 'block', fontSize: '0.92rem', color: 'var(--charcoal)', marginBottom: 3 }}>We review your payment</strong><p style={{ fontSize: '0.85rem', color: 'var(--stone-dark)', margin: 0 }}>Our team checks your bank transfer and screenshot against the booking.</p></div>
            </div>
            <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
